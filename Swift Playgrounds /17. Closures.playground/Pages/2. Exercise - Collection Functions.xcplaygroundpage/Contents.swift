 ...
 */
var someArray = ["sam","lee","sara"]
var sortedCollection1 = someArray.sorted(by: forwards)
 ...
 */
var sortedCollection2 = someArray.sorted(by: {(s1:String,s2:String) -> Bool in return s1 < s2})
 ...
 */
var sortedCollection3 = someArray.sorted(by: <)
