...
func checkMeal(at meal:String) -> Meal? {
    return meals[meal]
}
print(checkMeal(at: "Breakfast"))
/*:
 ...
 */
func checkMealLog(forLog logName:String) -> [String:Any]? {
    return UserDefaults.standard.dictionary(forKey: logName)
}
print(checkMealLog(forLog: "mealLog"))
