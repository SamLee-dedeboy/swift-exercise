...
var runningInstance = RunningWorkout()
var swimmingInstance = SwimmingWorkout()
simpleWorkoutDescription(workout: runningInstance)
simpleWorkoutDescription(workout: swimmingInstance)
