 ...
 */
var walkingChallenges = ["walk 3 miles a day", "walk 10 miles a day"]
var runningChallenges = [" run 10 miles a day", "run 20 miles a day"]
/*:
...
if committedChallenges.isEmpty {
    ...
    print("the challenge you have chosen is \(committedChallenges.first!)")
} else {
